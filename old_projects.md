...
- [DeLiCE: Decentralised Ledgers in Circular Economy](https://prin.unica.it/delice/) <span class="tooltip"><span class="tooltiptext">Co-PI</span></span>
- [BehAPI - Behavioural Application Program Interfaces](https://www.um.edu.mt/projects/behapi)<span class="tooltip"><span class="tooltiptext">Site leader and Work package leader (Marie Skłodowska-Curie Actions RISE, agreement No 778233, €742,500.00)</span></span>
